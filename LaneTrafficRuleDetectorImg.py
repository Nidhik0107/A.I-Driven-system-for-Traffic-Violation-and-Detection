...
#                                 cv2.imwrite('laneOutput/Det_'+str(imgCounter)+'.png',rid_im0)
#                                 existingOutputs.append(str(rider_helmet_status)+'\n'+str(rider_lp_status)+'\n'+str(rider_lp_number)+'\n'+str(no_of_passengers)+"\nSignal Breaked")
#                                 lines = 'laneOutput/Det_'+str(imgCounter)+'.png\n'+str(rider_helmet_status)+'\n'+str(rider_lp_status)+'\n'+str(rider_lp_number)+'\n'+str(no_of_passengers)+"\nSignal Breaked"
#                                 with open('laneOutput/temp.txt', 'w') as f:
#                                     f.writelines(lines)
...
# start_detecttion("test_images/498490_1_En_37_Fig2_HTML.png")

## if u want more logiic for wrong way detection and all call zeline support